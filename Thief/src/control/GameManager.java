...
public class GameManager {
	...
	public void sortScorePlyer() {// TODO score
		...
		// for (int i = 0; i < this.scorePlayers.size(); i++) {
		// for (int j = i; j < this.scorePlayers.size(); j++) {
		// if (((ArrayList<NodeCharacter>) this.scorePlayers).get(j)
		// .getScore() > ((ArrayList<NodeCharacter>)
		// this.scorePlayers).get(i).getScore()) {
		// NodeCharacter character = ((ArrayList<NodeCharacter>)
		// this.scorePlayers).get(i);
		...
		// }
		// for (int i = 0; i < this.scorePlayers.size(); i++) {
		// this.multiplayer.setPlayerInScoreLists(((ArrayList<NodeCharacter>)
		// this.scorePlayers).get(i).getName()
		// + ": " + ((ArrayList<NodeCharacter>)
		// this.scorePlayers).get(i).getScore() + "", i);
		// }
		// } else
		//
		// {
		// this.multiplayer.setPlayerInScoreLists(((ArrayList<NodeCharacter>)
		// this.scorePlayers).get(0).getName()
		// + ": " + ((ArrayList<NodeCharacter>)
		// this.scorePlayers).get(0).getScore() + "", 0);
		// }
		// for (int i = 0; i < this.scorePlayers.size(); i++) {
		// System.out.println(((ArrayList<NodeCharacter>)
		// this.scorePlayers).get(i).getScore() + "");
		// }
